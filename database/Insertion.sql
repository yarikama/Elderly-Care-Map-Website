...
SELECT ins_num, addr, LEFT(addr, 3) as city, dist, longitude, latitude
FROM tmp1;

INSERT INTO ins_info (ins_num, manager, phone, website)
SELECT ins_num, host_name, phone0, website
FROM tmp1;

INSERT INTO ins_capacity (ins_num, caring_num, nurse_num, dem_num, long_caring_num, housing_num, providing_num)
...
INSERT INTO type_func (ins_num, func_name)
